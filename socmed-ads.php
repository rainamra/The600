...
<header>
    ...
    <div class="banner seo-banner row">
        <div class="left-side column">
            <h1>Social Media <span class="color-red">Ads Management</span></h1>
    ...
    <div class="seo-service">
        <h1>Best Social Media <span class="color-red">Ads Management</span></h1>
        ...
        <div class="banner row">
            <div class="left-side"><img src="./assets/images/socmed-1.png" alt=""></div>
            <div class="right-side">
        ...
        <div class="services column">
            <div class="row">
                <div class="content">
                    <div class="top">
                        <h4>Our types of Social Media Ads Management</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer venenatis ligula sed dui consequat iaculis.</p>
                        <img src="./assets/images/socmed-2.png" alt="">
                    </div>
                    <ul class="column">
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>Highly Engaging Ads Designs</h5>
                        ...
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>Target Audience Experiment</h5>
                                    <i class="fa fa-chevron-down" style="font-size: 18px;"></i>
                        ...
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>Tracking Pixel Monitoring</h5>
                                    <i class="fa fa-chevron-down" style="font-size: 18px;"></i>
                                    <i class="fa fa-chevron-up" style="font-size: 18px;"></i></a>
                                <div class="column service-dropdown-content" id="dropdownService">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer venenatis ligula sed dui consequat iaculis.</p>
