...
<header>
    ...
    <div class="banner seo-banner row">
        <div class="left-side column">
            <h1>Web Design & <span class="color-red">Development</span></h1>
    ...
    <div class="seo-service">
        <h1>Best Design & <span class="color-red">Development Service</span></h1>
        ...
        <div class="banner row">
            <div class="left-side"><img src="./assets/images/web-1.png" alt=""></div>
            <div class="right-side">
        ...
        <div class="services column">
            <div class="row">
                <div class="content">
                    <div class="top">
                        <h4>Our types of Web Design & Development</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer venenatis ligula sed dui consequat iaculis.</p>
                    ...
                    <ul class="column">
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>Full Custom Design</h5>
                        ...
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>High Conversion Landing Pages</h5>
                                    <i class="fa fa-chevron-down" style="font-size: 18px;"></i>
                        ...
                        <div>
                            <li class="service-dropdown" href="javascript:void(0)" onclick="serviceStyle(this); myDropdownFunc(this)">
                                <a class="bold-font service-dropbtn"><h5>SEO Friendly</h5>
                                    <i class="fa fa-chevron-down" style="font-size: 18px;"></i>
                                    <i class="fa fa-chevron-up" style="font-size: 18px;"></i></a>
                                <div class="column service-dropdown-content" id="dropdownService">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer venenatis ligula sed dui consequat iaculis.</p>
